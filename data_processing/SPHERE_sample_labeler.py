...
class ImageLabeller:
    def __init__(self, master, image_paths, labels_file):
        ...
        with open(os.path.join(SPHERE_DATA_FOLDER, 'PSF_classes.txt'), 'r') as f:
...
if __name__ == "__main__":
    ...
    image_folder = os.path.join(SPHERE_DATA_FOLDER, 'IRDIS_images')
    ...
    labels_file = os.path.join(SPHERE_DATA_FOLDER, 'labels.txt')

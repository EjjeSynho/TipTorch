...
def load_and_fit_sample(id):
    ...
    save_data = {
        ...
        'beta':        to_store(model.beta)  if Moffat_absorber else None,
        'ratio':       to_store(model.ratio) if Moffat_absorber else None,
        'theta':       to_store(model.theta) if Moffat_absorber else None,

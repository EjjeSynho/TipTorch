...
from tools.plotting import plot_radial_profiles, SR, draw_PSF_stack, rad2mas, mask_circle
...
if len(toy.wvl[0]) > 1:
    ...
    for i, lmbd in enumerate(wvl_select):
        plot_radial_profiles( PSF_disp(PSF_0, lmbd),  PSF_disp(PSF_1, lmbd),  'Data', 'TipTorch', cutoff=60,  ax=ax[i] )
    plt.show()

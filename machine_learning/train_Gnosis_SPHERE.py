...
from tiptorch._config import SPHERE_DATASET_FOLDER, SPHERE_DATA_FOLDER, default_device
...
p_0, p_1, p_err = plot_radial_PSF_profiles(
...
with torch.no_grad():
    ...
    for wvl in wvls_L_all:
        ...
        if calculate_plots:
            ...
            plot_radial_PSF_profiles(PSFs_0_val, PSFs_2_val, 'Data', 'TipTorch', title='Direct prediction',     ax=ax[0])
            plot_radial_PSF_profiles(PSFs_0_val, PSFs_1_val, 'Data', 'TipTorch', title='Calibrated prediction', ax=ax[1])
            # plot_radial_PSF_profiles(PSFs_0_val, PSFs_3_val, 'Data', 'TipTorch', title='Fitted', ax=ax[2])
...
fig, ax = plt.subplots(1, 2, figsize=(10, 4))
plot_radial_PSF_profiles(PSFs_0_val_poly, PSFs_2_val_poly, 'Data', 'TipTorch', title='Direct prediction',     ax=ax[0])
if fitted_or_pred == 'pred':
    plot_radial_PSF_profiles(PSFs_0_val_poly, PSFs_1_val_poly, 'Data', 'TipTorch', title='Calibrated prediction', ax=ax[1])
elif fitted_or_pred == 'fitted':
    plot_radial_PSF_profiles(PSFs_0_val_poly, PSFs_3_val_poly, 'Data', 'TipTorch', title='Fitted', ax=ax[1])
...
# plot_radial_PSF_profiles(PSF_0_val, PSF_2_val, 'Data', 'TipTorch', title='Direct prediction',     ax=ax[0])
